...
public class SesameConversationInstrumentedTest {
  ...
  public void testEncryptDecryptMultipleDevice() throws Exception {
    ...
    // Alice add his own bundle public collection
    ...
    aliceConversation1.initializeSender();
  ...
  @Test
  public void twoSenderDevice() throws Exception {
    mailBoxes = new HashMap<>();
  ...
  public void addNewDevice() throws Exception {
    ...
    // Bob 1 replies too
    String bobMessage3 = "Noice alice!";
    encrypted = bobConversation1.encrypt(bobMessage3.getBytes());

    // Alice got message
    decrypted = aliceConversation.decrypt(unpackData(aliceDevice.id, encrypted));
    Assert.assertEquals(Arrays.equals(decrypted, bobMessage3.getBytes()), true);

    // Alice replies
    String aliceMessage3 = "Awesome!!";
    encrypted = aliceConversation.encrypt(aliceMessage3.getBytes());
  ...
  @Test
  public void testEncryptDecryptMultipleDevice2ndVariant() throws Exception {
